...
import ai.yarmook.domain.JobHistory;
import ai.yarmook.repository.JobHistoryRepository;
import ai.yarmook.service.JobHistoryService;
import ai.yarmook.web.rest.errors.BadRequestAlertException;
import ai.yarmook.web.rest.errors.ElasticsearchExceptionMapper;
import java.net.URI;
...
/**
 * REST controller for managing {@link ai.yarmook.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")

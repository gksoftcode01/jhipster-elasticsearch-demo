...
import ai.yarmook.domain.Job;
import ai.yarmook.repository.JobRepository;
import ai.yarmook.repository.search.JobSearchRepository;
...
/**
 * REST controller for managing {@link ai.yarmook.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional

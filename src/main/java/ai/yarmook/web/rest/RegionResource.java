...
import ai.yarmook.domain.Region;
import ai.yarmook.repository.RegionRepository;
import ai.yarmook.service.RegionService;
...
/**
 * REST controller for managing {@link ai.yarmook.domain.Region}.
 */
@RestController
@RequestMapping("/api")

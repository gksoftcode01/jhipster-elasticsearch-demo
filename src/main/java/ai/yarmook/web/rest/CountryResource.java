...
import ai.yarmook.domain.Country;
import ai.yarmook.repository.CountryRepository;
import ai.yarmook.service.CountryService;
...
/**
 * REST controller for managing {@link ai.yarmook.domain.Country}.
 */
@RestController
@RequestMapping("/api")

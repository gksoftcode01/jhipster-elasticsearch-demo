...
import ai.yarmook.domain.Task;
import ai.yarmook.repository.TaskRepository;
import ai.yarmook.service.TaskService;
...
/**
 * REST controller for managing {@link ai.yarmook.domain.Task}.
 */
@RestController
@RequestMapping("/api")

...
import ai.yarmook.domain.Location;
import ai.yarmook.repository.LocationRepository;
import ai.yarmook.service.LocationService;
...
/**
 * REST controller for managing {@link ai.yarmook.domain.Location}.
 */
@RestController
@RequestMapping("/api")
